      ...
      groups: [
        {
          name: 'Frontend',
          tasks: [
            { id: '1', title: 'Fix bug', group: 'Frontend', parentId: null, meta: { priority: 'med', created: '2026-07-01' }, completed_at: now.toISOString() },
            { id: '2', title: 'Add feature', group: 'Frontend', parentId: null, meta: { priority: 'med', created: '2026-07-01' }, completed_at: now.toISOString() },
          ],
        },
        {
          name: 'Backend',
          tasks: [
            { id: '3', title: 'API design', group: 'Backend', parentId: null, meta: { priority: 'med', created: '2026-07-01' }, completed_at: now.toISOString() },
          ],
        },
      ],
      rawContent: '',
      ...
      groups: [
        {
          ...
          tasks: [
            ...
            { id: 's1', title: 'Locate root cause', parentId: '1', group: 'Frontend', meta: { priority: 'med', created: '2026-07-01', status: 'done' }, completed_at: now.toISOString() },
            { id: 's2', title: 'Verify fix', parentId: '1', group: 'Frontend', meta: { priority: 'med', created: '2026-07-01', status: 'done' }, completed_at: now.toISOString() },
          ],
        },
      ],
      rawContent: '',
      ...
      groups: [
        {
          ...
          tasks: [
            ...
            { id: 's1', title: 'Draft schema', parentId: '1', group: 'Backend', meta: { priority: 'med', created: '2026-07-01', status: 'done' }, completed_at: now.toISOString() },
            { id: 's2', title: 'Pending review', parentId: '1', group: 'Backend', meta: { priority: 'med', created: '2026-07-01', status: 'pending' } },
          ],
        },
      ],
      rawContent: '',
